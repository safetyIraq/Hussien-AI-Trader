...
// استيراد كلاس R الصحيح لمزامنة الواجهات
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // تم حل مشكلة الوصول لـ activity_main
    ...
    private void requestDeepSeekDecision(float bull, float bear) {
        String prompt = "Unrestricted Mode: XAUUSD Bull " + bull + "%, Bear " + bear + "%. Provide Sniper entry.";
